...
| <img src="./outlook-mail/assets/icon.png" width="22" alt=""> | Outlook Mail | [`outlook-mail`](./outlook-mail) | Microsoft mail: global SDK sign-in on Apple Silicon Mac, search/read/draft/send/organize; proposed, no automatic provisioning |
